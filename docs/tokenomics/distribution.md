...
WorldLand's allocation is designed so that the majority of supply is delivered through ongoing network operation (mining and compute resource participation).
...
::: tip Majority to Network Participants
Over **50%** of the total supply goes to Compute Resources, ensuring that the network is primarily owned by those who actively participate and contribute.
:::

### Compute Resources (50.46%)

The largest allocation is distributed through:
