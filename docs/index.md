...
description: 'WorldLand: Decentralized GPU Infrastructure Network for the AI Era'
---
...
As a DePIN, WorldLand leverages Web3 to enable incentivization and consumption tracking. Resource owners—called Providers—are rewarded in WorldLand's native **WLC token** for contributing resources to the network, while the ECCVCC blockchain is used to track resource consumption by end users and facilitate the transfer of rewards. Providers earn 90% of service fees, with the remaining 10% going to the protocol treasury for ecosystem development.
...
[WorldLand Whitepaper](/whitepaper/)
