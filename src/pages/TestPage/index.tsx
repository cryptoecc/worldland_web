...
const TestPage = () => {
  ...
  const sendTransaction = async (priceValues: any) => {
    ...
    if (worldland_web3) {
      console.log('@이건 또 먼 값임??', priceValues);
      ...
      //   nonce: nonce,
      // };
      const txObject: TransactionWithFromAndToLocalWalletIndex = {
      ...
      console.log('이걸 보낸다고?', txObject);
      console.log('@이값이 찍히니?', contract.methods.setMarketPricesAtPool as any);
      // console.log(
      //   'tx오브젝트',
