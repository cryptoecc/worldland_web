      ...
      <section className="content-wrap">
        ...
        <section className="inner-section">
          ...
          <section className="deposit-field">
            ...
            <div className="input-hold">
              <div className="input-wrap">
                ...
                <div className="inner-items">
                  ...
                  <p className="balance">
                    Balance: 0 <span className="max-btn">MAX</span>
                  </p>
                </div>
              </div>
              <div className="input-wrap">
            ...
            <button onClick={handleAddLiquidity} className="deposit-btn">
              Add liquidity
            </button>
            {/* <button onClick={AddLiquidity} className="deposit-btn">Enter an amount</button> */}
            {/* <button onClick={handleApprovals} className="deposit-btn">
              {allowanceA > 0 ? 'Insufficient DAI balance' : 'Approve'}
            </button> */}
          </section>
        </section>
      </section>
